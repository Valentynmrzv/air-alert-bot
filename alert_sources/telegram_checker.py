...
THREAT_KEYWORDS = [
    ...
    "вибух", "вибухи", "взрыв", "приліт", "влучан",
...
async def _process_message(username: str, text: str, msg_id: int, msg_date):
    lower = text.lower()
    ...
    await _queue_classified_message(classified, text, username, url, msg_date)
