...
if __name__ == "__main__":
    ...
    print("м. Бровари:", check_air_alert("м. Бровари"))
    print("Броварська ТГ:", check_air_alert("Броварська територіальна громада"))
    print("Київська обл:", check_air_alert("Київська область"))
